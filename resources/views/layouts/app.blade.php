        ...
        <div class="min-h-full">
            ...
            <nav class="fixed bottom-0 left-0 right-0 z-50 border-t bg-slate-900/95 backdrop-blur-lg border-slate-800 lg:hidden">
                <div class="flex justify-around items-center h-16 max-w-lg mx-auto">
                    ...
                    <a href="{{ route('accounts.index') }}" class="flex flex-col items-center justify-center w-16 h-full text-slate-400 hover:text-indigo-400">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <a href="{{ route('transactions.index') }}" class="flex flex-col items-center justify-center w-16 h-full text-slate-400 hover:text-indigo-400">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <a href="{{ route('profile.edit') }}" class="flex flex-col items-center justify-center w-16 h-full text-slate-400 hover:text-indigo-400">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
