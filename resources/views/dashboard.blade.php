<x-app-layout>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class="p-6 transition-all border group bg-slate-800/50 backdrop-blur-sm border-slate-700/50 rounded-2xl">
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div class="lg:col-span-2 overflow-hidden border bg-slate-800/50 backdrop-blur-sm border-slate-700/50 rounded-2xl">
                <div class="flex items-center justify-between p-6 border-b border-slate-700/50">
                    ...
                    <a href="{{ route('transactions.index') }}" class="text-sm font-medium text-indigo-400 hover:text-indigo-300">Ver todas</a>
                </div>
            ...
            <div class="space-y-6">
                <div class="p-6 border bg-slate-800/50 backdrop-blur-sm border-slate-700/50 rounded-2xl">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a href="{{ route('transactions.create') }}" class="flex flex-col items-center justify-center p-4 transition-all border border-slate-700 rounded-xl hover:bg-indigo-500/10 hover:border-indigo-500/50 group">
                        ...
                        <a href="{{ route('transactions.create') }}" class="flex flex-col items-center justify-center p-4 transition-all border border-slate-700 rounded-xl hover:bg-rose-500/10 hover:border-rose-500/50 group">
                ...
                <div class="p-6 border bg-slate-800/50 backdrop-blur-sm border-slate-700/50 rounded-2xl">
                    ...
                    <p class="mt-4 text-xs text-slate-500">Você ainda tem R$ {{ number_format($monthlyLimitAvailable, 2, ',', '.') }} disponíveis.</p>
                </div>
            </div>
        </div>
    </div>
